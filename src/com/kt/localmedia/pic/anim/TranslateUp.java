 ...
 *
 */
public class TranslateUp implements ITurnPage {
...
//					canvas.restore();
					...
					{
						src.set(0, (int)(maxHeight-((float)runMills/(float)duration)*maxHeight),  maxWidth,maxHeight);
...
//					canvas.translate(0, -(int)(maxWidth*((float)runMills/(float)duration)));
